...
<nav class="tf-breadcrumb mb-3">
    ...
    <span>›</span>
    <span class="active">Create Task</span>
</nav>

{{-- Page Header --}}
<div class="tf-page-header mb-4">
    <div>
        <h1 class="tf-page-title">Create Task</h1>
        <div class="tf-title-underline"></div>
        <p class="tf-page-subtitle mt-2">
            Add a new task to track work and progress within your project.
        </p>
    </div>
</div>
...
<form action="{{ route('projects.tasks.store', $project) }}" method="POST" id="createTaskForm">
    @csrf
                ...
                <div class="tf-card__body">
                    ...
                    <div class="tf-form-group">
                        ...
                        <textarea name="description"
                                  ...
                                  placeholder="Describe the task, its purpose, and any important details...">{{ old('description') }}</textarea>
                ...
                <div class="tf-card__body">
                    ...
                    <div class="tf-summary-item">
                        ...
                        <div>
                            ...
                            <span class="tf-summary-value" id="summaryAssignee">—</span>
                        </div>
                    </div>
                    <div class="tf-summary-item">
                        <i class="bi bi-calendar3"></i>
                        <div>
                            ...
                            <span class="tf-summary-value" id="summaryDueDate">—</span>
                        </div>
                    </div>
                    <div class="tf-summary-item">
                        <i class="bi bi-flag"></i>
                        <div>
                            ...
                            <span class="tf-summary-value" id="summaryPriority">—</span>
                        </div>
                    </div>
                    <div class="tf-summary-item">
                        ...
                        <div>
                            ...
                            <span class="tf-summary-value" id="summaryStatus">—</span>
                        </div>
                    </div>
                </div>
            </div>
